...
//          target.prependJavascript("alert('Cannot process the input: " + e.getMessage() + "');");
	...
	private Component getProcessorSelect() {
		...
		final Component component = new DropDownChoice<ResourcePostProcessor>("selectProcessor",
				new PropertyModel<ResourcePostProcessor>(this, "processor"), listModel, renderer);
		return component;
	}
