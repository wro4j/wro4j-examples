...
caplin.namespace("gmp.component.beneficiary");

caplin.include("knockout.knockout-mapping");
caplin.include("gmp.knockout.BindingHandlers");
caplin.include("gmp.knockout.SwiftChooserBindingHandler");
caplin.include("gmp.component.beneficiary.model.ClientBeneficiaryModel");
caplin.include("gmp.component.beneficiary.model.BankDetailsDisplayModel");
caplin.include("gmp.component.beneficiary.model.BankDetailsFromCountryCode");
caplin.include("gmp.component.beneficiary.formatters.AddEditBeneficiaryFormatters");
caplin.include("gmp.event.EditPendingItemListener");
 ...
 * Inheritance.
 */
caplin.implement(gmp.component.beneficiary.AddEditBeneficiaryComponent, gmp.component.knockout.KnockoutComponent);
caplin.implement(gmp.component.beneficiary.AddEditBeneficiaryComponent, gmp.event.EditPendingItemListener);
